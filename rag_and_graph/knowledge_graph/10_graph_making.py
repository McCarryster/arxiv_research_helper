...
# 1. Read 1 line from jsonl file
# 2. Using arxiv id from jsonl line, query postgresql for relevant metadata
# 3. Query weaviate db for embedding id for paper and for chunks

# 4. Graph building:
    # 1. Create nodes Paper, Chunk, Author, Category
    # 2. Create edges:
        # 1. Paper -[AUTHORED_BY]-> Author
        # 2. Paper -[IN_CATEGORY]-> Category
        # 3. Paper -[CITES]-> Paper
        # 4. Paper -[HAS_CHUNK]-> Chunk
        # 5. Chunk -[SIMILAR_TO]-> Chunk
        # 6. Chunk -[CITES]-> Paper
